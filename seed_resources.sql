...
('rubric', '논술 평가를 위한 4점 루브릭 가이드', '논술 평가에서 가장 많이 사용되는 4점 척도 루브릭에 대해 알아보겠습니다.
...
('rubric', '중학교 논술 평가 기준', '중학교 학생들의 논술을 평가할 때 고려해야 할 핵심 기준들을 소개합니다.
...
('rubric', '고등학교 대학 수시 논술 루브릭', '대학 수시 논술 평가에 활용할 수 있는 상세 루브릭입니다.
...
-- Evaluation posts
INSERT INTO resource_posts (category, title, content, author) VALUES 
('evaluation', '효과적인 논술 피드백 작성 방법', '학생들에게 도움이 되는 논술 피드백을 작성하는 방법을 알아봅시다.
...
('evaluation', '논술 평가 시 흔한 실수와 해결책', '교사들이 논술을 평가할 때 자주 하는 실수와 그 해결책을 공유합니다.
...
('evaluation', '학년별 논술 평가 포인트', '학년별로 중점적으로 평가해야 할 항목들을 정리했습니다.
