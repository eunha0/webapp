    ...
    <body class="bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <p class="text-gray-700 mb-3 leading-relaxed">이 이용약관에 대한 문의사항이 있으시면 고객센터(02-6339-6059)로 연락주시기 바랍니다.</p>            </div>
    ...
    <body class="bg-gray-50">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-white rounded-lg shadow-lg p-8">
                ...
                <p class="text-gray-700 mb-3 leading-relaxed">본 개인정보 처리방침에 대한 문의사항이 있는 분은 고객센터(02-6339-6059)로 연락 주시기 바랍니다.</p>            </div>
