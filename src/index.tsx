...
app.get('/rubric-detail/:rubricId', (c) => {
  ...
  const rubricData: Record<string, { title: string, pdf: string, criteria: Array<{ name: string, desc: string }> }> = {
    ...
    'kr_elementary': {
      ...
      criteria: [
        { name: '핵심 개념의 이해와 분석', desc: '주제에 대한 이해가 정확하고, 핵심 개념을 명확하게 설명합니다.', max_score: 4 },
        { name: '증거와 역사적 사례 활용', desc: '구체적인 사례와 증거를 활용하여 주장을 뒷받침합니다.', max_score: 4 },
        { name: '출처 인용의 정확성', desc: '정보의 출처를 정확하게 인용하고 활용합니다.', max_score: 4 },
        { name: '문법 정확성, 구성 및 흐름', desc: '문법이 정확하고, 글의 흐름이 자연스럽습니다.', max_score: 4 }
      ]
    },
    'kr_middle': {
      title: '중학생용 평가 기준',
      ...
      criteria: [
        { name: '논제의 명확성', desc: '논제가 명확하게 제시되고, 글의 목적이 분명합니다.', max_score: 4 },
        { name: '논거의 타당성', desc: '논리적이고 설득력 있는 근거를 제시합니다.', max_score: 4 },
        { name: '증거 활용', desc: '제시문과 역사적 사례를 효과적으로 활용합니다.', max_score: 4 },
        { name: '구조와 조직', desc: '글의 구조가 체계적이고 논리적으로 조직되어 있습니다.', max_score: 4 },
        { name: '언어와 문체', desc: '적절한 어휘와 문체를 사용하여 명확하게 표현합니다.', max_score: 4 },
        { name: '비판적 사고', desc: '다양한 관점을 고려하고 비판적으로 사고합니다.', max_score: 4 }
      ]
    },
    'kr_high': {
      title: '고등학생용 평가 기준',
