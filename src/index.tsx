...
// Email Verification Handler - Removed frontend page
// Backend API at /api/auth/verify-email handles verification and redirects directly
...
app.get('/my-page', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50">
                        ...
                        <div id="accountTabContent" class="space-y-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="border-t border-gray-200 pt-6">
                                    ...
                                    <p class="text-sm text-gray-600 mb-4">계정을 삭제하면 이름과 이메일 주소 등 개인 정보가 사라지고 복구할 수 없습니다. <a href="#" onclick="handleAccountDelete(event)" class="text-blue-600 hover:underline">탈퇴하기</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script src="https://cdn.jsdelivr.net/npm/dompurify@3.0.8/dist/purify.min.js"></script>
        ${STORAGE_UTILS_SCRIPT}
        <script src="/static/my-page-full.js?v=${Date.now()}"></script>
        <script>
