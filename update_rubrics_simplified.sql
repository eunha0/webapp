-- Update rubrics with simplified content and docx file links

-- 1. IB 고등학교 개인과 사회 논술 루브릭 (ID: 14)
...
-- 3. IB 과학 논술 루브릭 (ID: 16) - Add docx link
UPDATE resource_posts 
SET content = '
<div class="rubric-container">
...
'
WHERE id = 10 AND content NOT LIKE '%상세 평가 기준 문서%';
...
'
WHERE id = 11 AND content NOT LIKE '%상세 평가 기준 문서%';
...
'
WHERE id = 12 AND content NOT LIKE '%상세 평가 기준 문서%';
...
'
WHERE id = 13 AND content NOT LIKE '%상세 평가 기준 문서%';
